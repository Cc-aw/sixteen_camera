...
module frame_preprocess_accel #(
    ...
    axi4_if.master     m_read_axi,
    axi4_if.master     m_write_axi
);
    ...
    wire ar_fire = m_read_axi.arvalid && m_read_axi.arready;
    wire r_fire = m_read_axi.rvalid && m_read_axi.rready;
    wire aw_fire = m_write_axi.awvalid && m_write_axi.awready;
    wire w_fire = m_write_axi.wvalid && m_write_axi.wready;
    wire b_fire = m_write_axi.bvalid && m_write_axi.bready;

    assign m_read_axi.aclk = clk;
    assign m_read_axi.aresetn = resetn;
    assign m_read_axi.arid = 3'd0;
    assign m_read_axi.araddr = read_addr;
    assign m_read_axi.arlen = read_burst_beats[7:0] - 1'b1;
    assign m_read_axi.arsize = 3'b101;
    assign m_read_axi.arburst = 2'b01;
    assign m_read_axi.arlock = 1'b0;
    assign m_read_axi.arcache = 4'b0010;
    assign m_read_axi.arprot = 3'b000;
    assign m_read_axi.arqos = 4'h6;
    assign m_read_axi.arvalid = read_arvalid;
    assign m_read_axi.rready = (state == ST_RD_DATA) && !input_word_valid;
    assign m_read_axi.awid = 3'd0;
    assign m_read_axi.awaddr = 32'd0;
    assign m_read_axi.awlen = 8'd0;
    assign m_read_axi.awsize = 3'd0;
    assign m_read_axi.awburst = 2'd0;
    assign m_read_axi.awlock = 1'b0;
    assign m_read_axi.awcache = 4'd0;
    assign m_read_axi.awprot = 3'd0;
    assign m_read_axi.awqos = 4'd0;
    assign m_read_axi.awvalid = 1'b0;
    assign m_read_axi.wdata = 256'd0;
    assign m_read_axi.wstrb = 32'd0;
    assign m_read_axi.wlast = 1'b0;
    assign m_read_axi.wvalid = 1'b0;
    assign m_read_axi.bready = 1'b0;

    assign m_write_axi.aclk = clk;
    assign m_write_axi.aresetn = resetn;
    assign m_write_axi.awid = 3'd0;
    assign m_write_axi.awaddr = write_addr;
    assign m_write_axi.awlen = write_burst_beats[7:0] - 1'b1;
    assign m_write_axi.awsize = 3'b101;
    assign m_write_axi.awburst = 2'b01;
    assign m_write_axi.awlock = 1'b0;
    assign m_write_axi.awcache = 4'b0010;
    assign m_write_axi.awprot = 3'b000;
    assign m_write_axi.awqos = 4'h6;
    assign m_write_axi.awvalid = write_awvalid;
    assign m_write_axi.wdata = source_valid_q ? write_data : 256'd0;
    assign m_write_axi.wstrb = 32'hffff_ffff;
    assign m_write_axi.wlast = write_burst_sent + 1'b1 == write_burst_beats;
    assign m_write_axi.wvalid = state == ST_WR_DATA;
    assign m_write_axi.bready = state == ST_WR_RESP;
    assign m_write_axi.arid = 3'd0;
    assign m_write_axi.araddr = 32'd0;
    assign m_write_axi.arlen = 8'd0;
    assign m_write_axi.arsize = 3'd0;
    assign m_write_axi.arburst = 2'd0;
    assign m_write_axi.arlock = 1'b0;
    assign m_write_axi.arcache = 4'd0;
    assign m_write_axi.arprot = 3'd0;
    assign m_write_axi.arqos = 4'd0;
    assign m_write_axi.arvalid = 1'b0;
    assign m_write_axi.rready = 1'b0;
            ...
            case (state)
                ...
                ST_RD_DATA: begin
                    if (r_fire) begin
                        ...
                        if (m_read_axi.rid != 0 || m_read_axi.rresp != 2'b00 ||
                            m_read_axi.rlast != (read_burst_received + 1'b1 ==
                                            read_burst_beats))
                            error <= 1'b1;
                ...
                ST_WR_RESP: begin
                    if (b_fire) begin
                        if (m_write_axi.bid != 0 || m_write_axi.bresp != 2'b00)
                            error <= 1'b1;
