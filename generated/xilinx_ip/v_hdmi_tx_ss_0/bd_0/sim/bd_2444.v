...
//--------------------------------------------------------------------------------
//Command: generate_target bd_2444.bd
//Design : bd_2444
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_2444,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_2444,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "v_hdmi_tx_ss_0.hwdef" *) 
module bd_2444
   (AUDIO_IN_tdata,
    AUDIO_IN_tid,
    AUDIO_IN_tready,
  ...
  wire [7:0]intf_net_bdry_in_SB_STATUS_IN_TDATA;
  ...
  assign intf_net_bdry_in_SB_STATUS_IN_TDATA = SB_STATUS_IN_tdata[7:0];
  ...
  bd_2444_axi_crossbar_0 axi_crossbar
  ...
  bd_2444_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(net_v_hdmi_tx_video_reset),
        .Res(net_util_vector_logic_0_Res));
  bd_2444_v_axi4s_vid_out_0 v_axi4s_vid_out
