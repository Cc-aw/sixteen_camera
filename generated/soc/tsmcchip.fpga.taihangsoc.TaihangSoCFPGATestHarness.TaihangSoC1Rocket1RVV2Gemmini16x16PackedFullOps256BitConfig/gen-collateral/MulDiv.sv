...
module MulDiv(	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:40:7]
    ...
    else if (io_resp_ready & io_resp_valid_0)	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:182:42, src/main/scala/chisel3/util/Decoupled.scala:51:35]
      state <= 3'h0;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:51:22]
    ...
    neg_out <= _GEN_3 ? ((&_decoded_andMatrixOutputs_T_1) ? lhs_sign : lhs_sign != rhs_sign) : ~(_GEN_1 & count == 7'h0 & ~(_subtractor_T_1[64]) & ~isHi) & neg_out;	// @[generators/rocket-chip/src/main/scala/rocket/Multiplier.scala:54:18, :57:20, :58:17, :81:23, :88:37, :129:{39,50}, :133:28, :146:{24,32,35}, :159:{18,21,28,38}, :164:22, :169:{13,19,46}, src/main/scala/chisel3/util/Decoupled.scala:51:35, src/main/scala/chisel3/util/pla.scala:98:{53,70}]
