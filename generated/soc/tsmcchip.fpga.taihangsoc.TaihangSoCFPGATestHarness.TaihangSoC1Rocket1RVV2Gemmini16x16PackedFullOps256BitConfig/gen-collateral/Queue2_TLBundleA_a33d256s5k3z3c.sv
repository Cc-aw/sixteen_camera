...
module Queue2_TLBundleA_a33d256s5k3z3c(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  wire [335:0] _ram_ext_R0_data;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  ram_2x336 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({289'hFFFFFFFF, io_enq_bits_address, io_enq_bits_source, 3'h6, io_enq_bits_param, io_enq_bits_opcode})	// @[src/main/scala/chisel3/util/Decoupled.scala:255:14, :256:91]
  ...
  assign io_deq_bits_address = _ram_ext_R0_data[46:14];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_mask = _ram_ext_R0_data[78:47];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_data = _ram_ext_R0_data[334:79];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_corrupt = _ram_ext_R0_data[335];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
