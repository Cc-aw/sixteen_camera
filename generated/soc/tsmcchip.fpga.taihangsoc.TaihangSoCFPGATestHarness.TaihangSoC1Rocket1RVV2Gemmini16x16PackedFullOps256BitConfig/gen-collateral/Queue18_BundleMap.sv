...
module Queue18_BundleMap(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  always @(posedge clock) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
    if (reset) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
      ...
      if (do_enq)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        enq_ptr_value <= enq_ptr_value == 5'h11 ? 5'h0 : enq_ptr_value + 5'h1;	// @[src/main/scala/chisel3/util/Counter.scala:61:40, :73:24, :77:{15,24}, :87:{20,28}]
      if (do_deq)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
        deq_ptr_value <= deq_ptr_value == 5'h11 ? 5'h0 : deq_ptr_value + 5'h1;	// @[src/main/scala/chisel3/util/Counter.scala:61:40, :73:24, :77:{15,24}, :87:{20,28}]
  ...
  ram_18x17 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
