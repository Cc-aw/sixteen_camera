...
module Queue2_TLBundleB_a33d256s6k5z4c(	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7]
  ...
  ram_2x45 ram_ext (	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    .W0_clk  (clock),
    .W0_data ({io_enq_bits_address, 10'h206, io_enq_bits_param})	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign io_deq_bits_source = _ram_ext_R0_data[11:6];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
  assign io_deq_bits_address = _ram_ext_R0_data[44:12];	// @[src/main/scala/chisel3/util/Decoupled.scala:243:7, :256:91]
endmodule
