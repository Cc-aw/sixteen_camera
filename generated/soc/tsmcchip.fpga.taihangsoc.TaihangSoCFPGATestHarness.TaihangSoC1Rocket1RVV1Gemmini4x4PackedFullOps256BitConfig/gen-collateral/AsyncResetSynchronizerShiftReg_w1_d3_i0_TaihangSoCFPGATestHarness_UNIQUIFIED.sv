...
module AsyncResetSynchronizerShiftReg_w1_d3_i0_TaihangSoCFPGATestHarness_UNIQUIFIED(	// @[generators/rocket-chip/src/main/scala/util/SynchronizerReg.scala:80:7]
  ...
  AsyncResetSynchronizerPrimitiveShiftReg_d3_i0_TaihangSoCFPGATestHarness_UNIQUIFIED output_chain(	// @[generators/rocket-chip/src/main/scala/util/ShiftReg.scala:45:23]
    .clock (clock),
    .reset (reset),
    .io_d  (io_d),
    .io_q  (io_q)
