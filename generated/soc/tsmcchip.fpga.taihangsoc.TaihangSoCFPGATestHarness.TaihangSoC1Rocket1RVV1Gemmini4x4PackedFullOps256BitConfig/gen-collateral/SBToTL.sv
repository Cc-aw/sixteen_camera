...
module SBToTL(	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
  ...
  wire [108:0]    _GEN_8 = {io_addrIn[127:29], io_addrIn[28:19] ^ 10'h201};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [107:0]    _GEN_9 = {io_addrIn[127:29], io_addrIn[28:20] ^ 9'h101};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [109:0]    _GEN_10 = {io_addrIn[127:29], io_addrIn[28:18] ^ 11'h408};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [96:0]     _GEN_11 = {io_addrIn[127:32], ~(io_addrIn[31])};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [96:0]     _GEN_12 = {io_addrIn[127:33], io_addrIn[32:31] ^ 2'h2};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire            io_rdLegal_0 = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | {io_addrIn[127:17], ~(io_addrIn[16])} == 112'h0 | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | ~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8) | ~(|_GEN_9) | ~(|_GEN_10) | ~(|_GEN_11) | ~(|_GEN_12);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:274:16, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  wire            io_wrLegal_0 = ~(|(io_addrIn[127:13])) | ~(|_GEN_0) | ~(|_GEN_1) | ~(|_GEN_2) | ~(|_GEN_3) | ~(|_GEN_4) | ~(|_GEN_5) | ~(|_GEN_6) | ~(|_GEN_7) | ~(|_GEN_8) | ~(|_GEN_9) | ~(|_GEN_10) | ~(|_GEN_11) | ~(|_GEN_12);	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:274:16, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{41,46,59}, generators/rocket-chip/src/main/scala/tilelink/Parameters.scala:685:42]
  ...
  wire            _GEN_13 = sbState == 3'h0;	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:295:26, :349:19]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
    always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:373:12]
      if (~reset & ~(_GEN_13 | _nodeOut_a_valid_T | _nodeOut_a_valid_T_1 | _rdTxValid_T | _io_wrDone_T)) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:299:{25,62}, :322:18, :338:29, :349:19, :373:{12,35}, :374:44, :375:45, :376:45]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
      ...
      if (_GEN_13) begin	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:349:19]
  ...
  Queue2_TLBundleD_a33d8s1k5z4u d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
  ...
  assign auto_out_a_bits_address = io_addrIn[32:0];	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9, generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:31]
