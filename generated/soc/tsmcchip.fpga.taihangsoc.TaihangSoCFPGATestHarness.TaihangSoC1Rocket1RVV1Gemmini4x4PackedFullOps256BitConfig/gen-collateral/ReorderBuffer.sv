...
module ReorderBuffer(	// @[generators/saturn/src/main/scala/common/ReorderBuffer.scala:12:7]
  ...
  `endif // not def SYNTHESIS
  wire        io_deq_valid_0 = ~(ptr_match & ~maybe_full) & (_GEN[deq_ptr_value] | io_push_valid & io_push_bits_tag == deq_ptr_value);	// @[generators/saturn/src/main/scala/common/ReorderBuffer.scala:33:27, :34:33, :35:{25,28}, :38:14, :46:12, :51:{26,52,69,89}, src/main/scala/chisel3/util/Counter.scala:61:40]
  ...
  wire        _GEN_0 = io_deq_ready & io_deq_valid_0;	// @[generators/saturn/src/main/scala/common/ReorderBuffer.scala:51:26, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  assign io_deq_valid = io_deq_valid_0;	// @[generators/saturn/src/main/scala/common/ReorderBuffer.scala:12:7, :51:26]
endmodule
