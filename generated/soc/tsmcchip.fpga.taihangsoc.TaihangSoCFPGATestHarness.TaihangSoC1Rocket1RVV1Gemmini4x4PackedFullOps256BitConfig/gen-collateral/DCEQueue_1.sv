...
module DCEQueue_1(	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
  ...
  wire             io_enq_ready_0 = io_deq_ready | ~(ptr_match & maybe_full);	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:27:27, :28:33, :30:24, :55:{16,19}, :69:{24,39}]
  ...
  wire             _GEN_27 = do_enq & enq_ptr_value == 2'h1;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16, :44:16, :45:24, src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  wire             _GEN_28 = do_enq & enq_ptr_value == 2'h2;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16, :44:16, :45:24, src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
    if (reset) begin	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
      ...
      valids_2 <= _GEN_28 | ~(do_deq & deq_ptr_value == 2'h2) & valids_2;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:23:23, :24:16, :39:16, :41:27, :44:16, :45:24, :46:27, src/main/scala/chisel3/util/Counter.scala:61:40, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
    ...
    logic [31:0] _RANDOM[0:34];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
    initial begin	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
        ...
        ram_0_vstart = {_RANDOM[6'h4][31:30], _RANDOM[6'h5][5:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_segstart = _RANDOM[6'h5][8:6];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_segend = _RANDOM[6'h5][11:9];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_rs1_data = {_RANDOM[6'h5][31:12], _RANDOM[6'h6], _RANDOM[6'h7][11:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vat = _RANDOM[6'hA][5:1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_rm = _RANDOM[6'hA][8:6];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_emul = _RANDOM[6'hA][10:9];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_debug_id = _RANDOM[6'hA][27:12];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_mop = _RANDOM[6'hA][29:28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_reduction = _RANDOM[6'hA][30];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_scalar_to_vd0 = _RANDOM[6'hA][31];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_wide_vd = _RANDOM[6'hB][0];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_wide_vs2 = _RANDOM[6'hB][1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_writes_mask = _RANDOM[6'hB][2];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_reads_vs1_mask = _RANDOM[6'hB][3];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_reads_vs2_mask = _RANDOM[6'hB][4];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_nf_log2 = _RANDOM[6'hB][7:6];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_renv1 = _RANDOM[6'hB][8];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_renv2 = _RANDOM[6'hB][9];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_renvd = _RANDOM[6'hB][10];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_renvm = _RANDOM[6'hB][11];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_wvd = _RANDOM[6'hB][12];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_seq = _RANDOM[6'hB][13];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_bits = {_RANDOM[6'hC][31:22], _RANDOM[6'hD][21:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vl = _RANDOM[6'hD][30:22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vtype_vsew = _RANDOM[6'hF][27:25];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vtype_vlmul_sign = _RANDOM[6'hF][28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vconfig_vtype_vlmul_mag = _RANDOM[6'hF][30:29];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vstart = _RANDOM[6'h10][16:9];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_segstart = _RANDOM[6'h10][19:17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_segend = _RANDOM[6'h10][22:20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_rs1_data = {_RANDOM[6'h10][31:23], _RANDOM[6'h11], _RANDOM[6'h12][22:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vat = _RANDOM[6'h15][16:12];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_rm = _RANDOM[6'h15][19:17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_emul = _RANDOM[6'h15][21:20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_debug_id = {_RANDOM[6'h15][31:23], _RANDOM[6'h16][6:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_mop = _RANDOM[6'h16][8:7];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_reduction = _RANDOM[6'h16][9];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_scalar_to_vd0 = _RANDOM[6'h16][10];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_wide_vd = _RANDOM[6'h16][11];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_wide_vs2 = _RANDOM[6'h16][12];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_writes_mask = _RANDOM[6'h16][13];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_reads_vs1_mask = _RANDOM[6'h16][14];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_reads_vs2_mask = _RANDOM[6'h16][15];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_nf_log2 = _RANDOM[6'h16][18:17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_renv1 = _RANDOM[6'h16][19];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_renv2 = _RANDOM[6'h16][20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_renvd = _RANDOM[6'h16][21];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_renvm = _RANDOM[6'h16][22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_wvd = _RANDOM[6'h16][23];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_seq = _RANDOM[6'h16][24];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_bits = {_RANDOM[6'h18][31:1], _RANDOM[6'h19][0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vl = _RANDOM[6'h19][9:1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vtype_vsew = _RANDOM[6'h1B][6:4];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vtype_vlmul_sign = _RANDOM[6'h1B][7];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vconfig_vtype_vlmul_mag = _RANDOM[6'h1B][9:8];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vstart = _RANDOM[6'h1B][27:20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_segstart = _RANDOM[6'h1B][30:28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_segend = {_RANDOM[6'h1B][31], _RANDOM[6'h1C][1:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_rs1_data = {_RANDOM[6'h1C][31:2], _RANDOM[6'h1D], _RANDOM[6'h1E][1:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_vat = _RANDOM[6'h20][27:23];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_rm = _RANDOM[6'h20][30:28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_emul = {_RANDOM[6'h20][31], _RANDOM[6'h21][0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_debug_id = _RANDOM[6'h21][17:2];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_mop = _RANDOM[6'h21][19:18];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_reduction = _RANDOM[6'h21][20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_scalar_to_vd0 = _RANDOM[6'h21][21];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_wide_vd = _RANDOM[6'h21][22];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_wide_vs2 = _RANDOM[6'h21][23];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_writes_mask = _RANDOM[6'h21][24];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_reads_vs1_mask = _RANDOM[6'h21][25];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_reads_vs2_mask = _RANDOM[6'h21][26];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_nf_log2 = _RANDOM[6'h21][29:28];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_renv1 = _RANDOM[6'h21][30];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_renv2 = _RANDOM[6'h21][31];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_renvd = _RANDOM[6'h22][0];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_renvm = _RANDOM[6'h22][1];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_wvd = _RANDOM[6'h22][2];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_2_seq = _RANDOM[6'h22][3];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        enq_ptr_value = _RANDOM[6'h22][5:4];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, src/main/scala/chisel3/util/Counter.scala:61:40]
        deq_ptr_value = _RANDOM[6'h22][7:6];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[6'h22][8];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, :27:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
