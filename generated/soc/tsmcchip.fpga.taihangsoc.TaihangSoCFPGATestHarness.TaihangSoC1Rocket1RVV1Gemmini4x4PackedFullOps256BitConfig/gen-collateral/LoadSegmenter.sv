...
module LoadSegmenter(	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7]
  ...
  wire [10:0]  _incr_T_3 = {3'h0, (|_seg_ready_T) ? {5'h0, sidx} : eidx} << _GEN;	// @[generators/saturn/src/main/scala/common/Bundles.scala:36:19, generators/saturn/src/main/scala/mem/LoadSegmenter.scala:31:17, :32:17, :35:{29,43,64}]
  ...
  wire [8:0]   next_eidx = {1'h0, eidx} + {4'h0, (|_seg_ready_T) ? 5'h1 : incr};	// @[generators/saturn/src/main/scala/common/Bundles.scala:36:19, generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7, :31:17, :35:95, :36:{22,36}, :38:24]
  wire [5:0]   _GEN_0 = {3'h0, sidx};	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:32:17, :39:24]
  wire [5:0]   next_sidx = _GEN_0 + {1'h0, incr};	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7, :35:95, :39:24]
  wire         sidx_tail = next_sidx > {3'h0, _seg_ready_T};	// @[generators/saturn/src/main/scala/common/Bundles.scala:36:19, generators/saturn/src/main/scala/mem/LoadSegmenter.scala:39:24, :41:29]
  wire         eidx_tail = next_eidx >= io_op_vl;	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:38:24, :42:29]
  wire [10:0]  _io_compactor_bits_head_T = {3'h0, eidx} << _GEN;	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:31:17, :35:64, :46:36]
  wire [11:0]  _io_compactor_bits_tail_T = {3'h0, io_op_vl} << io_op_elem_size;	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:47:55]
  ...
  wire         _GEN_1 = ((|_seg_ready_T) ? _segbuf_io_in_ready & io_compactor_ready & sidx_tail : ~_segbuf_io_busy & io_compactor_ready & io_resp_ready) & io_valid;	// @[generators/saturn/src/main/scala/common/Bundles.scala:36:19, generators/saturn/src/main/scala/mem/LoadSegmenter.scala:26:22, :35:43, :41:29, :74:22, :75:{5,21,43}, :76:{24,46}, :88:19]
  wire         _GEN_2 = _segbuf_io_in_ready & segbuf_io_in_valid;	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:26:22, :54:{34,58}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  always @(posedge clock) begin	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7]
    ...
    if (_GEN_2)	// @[src/main/scala/chisel3/util/Decoupled.scala:51:35]
      r_sidx <= next_sidx > {3'h0, io_op_nf} ? 3'h0 : next_sidx[2:0];	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:30:19, :39:24, :82:12, :83:{21,33}, :84:14]
    if (reset)	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7]
      ...
      r_head <= _GEN_1 ? eidx_tail : ~_GEN_2 & r_head;	// @[generators/saturn/src/main/scala/mem/LoadSegmenter.scala:29:23, :42:29, :78:28, :80:12, :88:{19,32}, :89:12, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  end // always @(posedge)
  ...
  assign io_compactor_bits_head = (|_seg_ready_T) ? _io_compactor_bits_head_T_1[3:0] : _io_compactor_bits_head_T[3:0];	// @[generators/saturn/src/main/scala/common/Bundles.scala:36:19, generators/saturn/src/main/scala/mem/LoadSegmenter.scala:11:7, :35:43, :44:31, :46:{28,36}, :50:{28,36}]
