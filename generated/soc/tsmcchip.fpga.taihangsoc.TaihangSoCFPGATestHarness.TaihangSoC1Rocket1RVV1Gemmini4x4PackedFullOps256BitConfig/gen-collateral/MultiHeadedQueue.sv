...
module MultiHeadedQueue(	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
    ...
    logic [31:0] _RANDOM[0:70];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
    initial begin	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7]
        ...
        regs_0_cmd_inst_funct = _RANDOM[7'h0][6:0];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_0_cmd_rs1 = {_RANDOM[7'h1], _RANDOM[7'h2]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_0_cmd_rs2 = {_RANDOM[7'h3], _RANDOM[7'h4]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_0_rob_id_bits = _RANDOM[7'h8][16:10];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_cmd_inst_funct = _RANDOM[7'h23][17:11];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_cmd_rs1 = {_RANDOM[7'h24][31:11], _RANDOM[7'h25], _RANDOM[7'h26][10:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_cmd_rs2 = {_RANDOM[7'h26][31:11], _RANDOM[7'h27], _RANDOM[7'h28][10:0]};	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        regs_1_rob_id_bits = _RANDOM[7'h2B][27:21];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :22:17]
        raddr = _RANDOM[7'h46][22];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :23:22]
        waddr = _RANDOM[7'h46][23];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :23:22, :24:22]
        len = _RANDOM[7'h46][25:24];	// @[generators/gemmini/src/main/scala/gemmini/MultiHeadedQueue.scala:7:7, :23:22, :25:20]
      `endif // RANDOMIZE_REG_INIT
    end // initial
