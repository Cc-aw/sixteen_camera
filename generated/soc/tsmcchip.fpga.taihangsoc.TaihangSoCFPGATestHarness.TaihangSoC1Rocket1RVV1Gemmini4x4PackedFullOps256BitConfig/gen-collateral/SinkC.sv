...
module SinkC(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
  ...
  output         io_bs_adr_bits_beat,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  output [3:0]   io_bs_adr_bits_mask,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  output [255:0] io_bs_dat_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  output [255:0] io_rel_beat_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:43:14]
  ...
  wire         r_beats1 = _c_q_io_deq_bits_opcode[0] & ~(_r_beats1_decode_T[5]);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:102:36, :221:14, generators/rocket-chip/src/main/scala/util/package.scala:244:{46,71,76}, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  reg          r_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  wire         _r_counter1_T = r_counter - 1'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :230:28]
  wire         last = r_counter | ~r_beats1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :229:27, :232:{33,43}]
  wire         beat = r_beats1 & ~_r_counter1_T;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:221:14, :230:28, :234:{25,27}]
  ...
  reg  [255:0] io_bs_dat_data_r;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:98:34]
  wire         bs_adr_valid = resp & (r_counter | _c_q_io_deq_valid & _c_q_io_deq_bits_opcode[0]);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:79:19, :99:{30,41,53}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:102:36, :229:27, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  wire [1:0]   put = r_counter ? put_r : freeIdx;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:140:{18,44}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, src/main/scala/chisel3/util/OneHot.scala:32:10]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
    if (reset) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
      ...
      if (c_q_io_deq_ready & _c_q_io_deq_valid) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:134:19, src/main/scala/chisel3/util/Decoupled.scala:51:35, :362:21]
    ...
    if (_c_q_io_deq_valid) begin	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
      ...
      bs_adr_bits_beat_r <= beat + _io_bs_adr_q_io_enq_ready;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:103:{53,59}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:234:25, src/main/scala/chisel3/util/Decoupled.scala:362:21]
    end
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
    ...
    logic [31:0] _RANDOM[0:8];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
    initial begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7]
        ...
        r_counter = _RANDOM[4'h0][0];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        resp_r = _RANDOM[4'h0][1];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :79:48, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        io_set_r = _RANDOM[4'h0][11:2];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :92:42, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        io_bs_dat_data_r = {_RANDOM[4'h0][31:12], _RANDOM[4'h1], _RANDOM[4'h2], _RANDOM[4'h3], _RANDOM[4'h4], _RANDOM[4'h5], _RANDOM[4'h6], _RANDOM[4'h7], _RANDOM[4'h8][11:0]};	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :98:34, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        bs_adr_bits_beat_r = _RANDOM[4'h8][12];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :98:34, :103:53]
        lists = _RANDOM[4'h8][14:13];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :98:34, :116:24]
        put_r = _RANDOM[4'h8][16:15];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, :98:34, :140:44]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ListBuffer_PutBufferCEntry_q2_e4 putbuffer (	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:115:27]
    .clock                     (clock),
    .reset                     (reset),
  ...
  assign io_req_bits_tag = _c_q_io_deq_bits_address[32:16];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:22, :216:19, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, src/main/scala/chisel3/util/Decoupled.scala:362:21]
  ...
  assign io_resp_bits_tag = _c_q_io_deq_bits_address[32:16];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:22, :216:19, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkC.scala:41:7, src/main/scala/chisel3/util/Decoupled.scala:362:21]
