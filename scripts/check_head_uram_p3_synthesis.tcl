...
if {[llength $worst_path] == 0} {
    error "No Head URAM P3 setup timing path was found"
}
set worst_slack [get_property SLACK $worst_path]
if {$worst_slack < 0.0} {
    error "Head URAM P3 100 MHz synthesis timing violation: $worst_slack ns"
}
puts "HEAD_URAM_P3_SYNTHESIS=PASS"
