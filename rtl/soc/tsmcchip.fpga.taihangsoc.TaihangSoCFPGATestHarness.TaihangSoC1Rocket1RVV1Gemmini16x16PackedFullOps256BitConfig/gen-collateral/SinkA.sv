...
module SinkA(	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
  ...
  output [16:0]  io_req_bits_tag,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  ...
  input  [32:0]  io_a_bits_address,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  input  [31:0]  io_a_bits_mask,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  input  [255:0] io_a_bits_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  ...
  output [255:0] io_pb_beat_data,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  output [31:0]  io_pb_beat_mask,	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:40:14]
  ...
  reg         first_counter;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  wire        req_block = ~first_counter & ~io_req_ready;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:70:{25,28}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
  ...
  wire        set_block = ~(io_a_bits_opcode[2]) & ~first_counter & (&lists);	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:52:22, :58:21, :72:{27,36}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:{28,37}, :229:27, :231:25]
  ...
  wire        _io_req_valid_T = io_a_valid & ~first_counter;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:79:27, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :231:25]
  reg  [5:0]  put_r;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:84:42]
  wire [5:0]  put = first_counter ? put_r : freeIdx;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:84:{16,42}, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, src/main/scala/chisel3/util/OneHot.scala:32:10]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
    if (reset) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
      ...
      first_counter <= 1'h0;	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
    end
      ...
      if (io_a_ready_0 & io_a_valid) begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:78:{25,39}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
        if (first_counter)	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
          first_counter <= first_counter - 1'h1;	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27, :230:28]
        else	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
          first_counter <= ~(io_a_bits_opcode[2]) & ~(_first_beats1_decode_T[5]);	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:92:{28,37}, :221:14, :229:27, generators/rocket-chip/src/main/scala/util/package.scala:244:{46,71,76}]
      end
    end
    if (first_counter) begin	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
    end
    else	// @[generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
    ...
    initial begin	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
        ...
        first_counter = _RANDOM[1'h1][8];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7, :52:22, generators/rocket-chip/src/main/scala/tilelink/Edges.scala:229:27]
        put_r = _RANDOM[1'h1][14:9];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7, :52:22, :84:42]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_req_bits_tag = io_a_bits_address[32:16];	// @[generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/Parameters.scala:215:22, :216:19, generators/rocket-chip-inclusive-cache/design/craft/inclusivecache/src/SinkA.scala:38:7]
