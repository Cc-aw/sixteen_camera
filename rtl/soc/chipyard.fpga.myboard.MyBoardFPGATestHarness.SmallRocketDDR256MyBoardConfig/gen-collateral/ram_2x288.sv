...
module ram_2x288(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input          R0_addr,
  input          R0_en,
  input          R0_clk,
  ...
  reg [287:0] Memory[0:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  assign R0_data = R0_en ? Memory[R0_addr] : 288'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
endmodule
