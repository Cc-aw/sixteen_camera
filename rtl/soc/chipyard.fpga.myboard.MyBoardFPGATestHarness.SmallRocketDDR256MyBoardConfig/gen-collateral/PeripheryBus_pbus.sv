...
module PeripheryBus_pbus(	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
  ...
  wire [7:0]  _coupler_to_bootaddressreg_auto_fragmenter_anon_out_a_bits_source;	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27]
  ...
  wire [3:0]  _coupler_to_bootaddressreg_auto_tl_in_d_bits_source;	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27]
  ...
  TLBuffer_a13d64s4k1z3u buffer (	// @[generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:75:28]
    ...
    .auto_out_a_ready        (_coupler_to_bootaddressreg_auto_tl_in_a_ready),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27]
    ...
    .auto_out_d_valid        (_coupler_to_bootaddressreg_auto_tl_in_d_valid),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27]
    .auto_out_d_bits_opcode  (_coupler_to_bootaddressreg_auto_tl_in_d_bits_opcode),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27]
    .auto_out_d_bits_param   (2'h0),	// @[generators/rocket-chip/src/main/scala/prci/ClockDomain.scala:14:9]
    .auto_out_d_bits_size    (_coupler_to_bootaddressreg_auto_tl_in_d_bits_size),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27]
    .auto_out_d_bits_source  (_coupler_to_bootaddressreg_auto_tl_in_d_bits_source),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27]
    .auto_out_d_bits_sink    (1'h0),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27, generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:75:28]
    .auto_out_d_bits_denied  (1'h0),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27, generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:75:28]
    .auto_out_d_bits_data    (_coupler_to_bootaddressreg_auto_tl_in_d_bits_data),	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27]
    .auto_out_d_bits_corrupt (1'h0)	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyScope.scala:99:27, generators/rocket-chip/src/main/scala/tilelink/Buffer.scala:75:28]
