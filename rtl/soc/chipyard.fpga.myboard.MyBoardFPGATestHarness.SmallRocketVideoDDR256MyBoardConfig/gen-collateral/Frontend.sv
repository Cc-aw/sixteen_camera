...
module Frontend(	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
  ...
  output [32:0] auto_icache_master_out_a_bits_address,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  output        auto_icache_master_out_a_bits_user_amba_prot_readalloc,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  output        auto_icache_master_out_a_bits_user_amba_prot_writealloc,	// @[generators/diplomacy/diplomacy/src/diplomacy/lazymodule/LazyModuleImp.scala:107:25]
  ...
  input  [34:0] io_cpu_req_bits_pc,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  ...
  output [34:0] io_cpu_resp_bits_pc,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  ...
  input  [30:0] io_ptw_pmp_0_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  input  [32:0] io_ptw_pmp_0_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  ...
  input  [30:0] io_ptw_pmp_1_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  input  [32:0] io_ptw_pmp_1_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  ...
  input  [30:0] io_ptw_pmp_2_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  input  [32:0] io_ptw_pmp_2_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  ...
  input  [30:0] io_ptw_pmp_3_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  input  [32:0] io_ptw_pmp_3_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  ...
  input  [30:0] io_ptw_pmp_4_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  input  [32:0] io_ptw_pmp_4_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  ...
  input  [30:0] io_ptw_pmp_5_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  input  [32:0] io_ptw_pmp_5_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  ...
  input  [30:0] io_ptw_pmp_6_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  input  [32:0] io_ptw_pmp_6_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  ...
  input  [30:0] io_ptw_pmp_7_addr,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  input  [32:0] io_ptw_pmp_7_mask,	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
  input  [63:0] io_ptw_customCSRs_csrs_0_value	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14]
);

  wire [33:0] _io_cpu_npc_T;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:186:28]
  wire        fq_io_enq_valid;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:184:{40,52}]
  wire [32:0] _tlb_io_resp_paddr;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:105:19]
  ...
  reg  [34:0] s1_pc;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:115:18]
  reg         s1_speculative;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:116:27]
  reg  [34:0] s2_pc;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:22]
  ...
  wire [34:0] predicted_npc = {s1_pc[34:2], 2'h0} + 35'h4;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:115:18, :129:25]
  ...
  assign _io_cpu_npc_T = io_cpu_req_valid ? io_cpu_req_bits_pc[34:1] : s2_replay ? s2_pc[34:1] : predicted_npc[34:1];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:85:14, :117:22, :129:25, :134:46, :135:16, :186:28]
  ...
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
    ...
    if (reset) begin	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
      ...
      s2_pc <= 35'h10000;	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:117:22]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
    ...
    initial begin	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7]
        ...
        s1_pc = {_RANDOM[3'h0][31:3], _RANDOM[3'h1][5:0]};	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :107:21, :115:18]
        s1_speculative = _RANDOM[3'h1][6];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :115:18, :116:27]
        s2_pc = {_RANDOM[3'h1][31:7], _RANDOM[3'h2][9:0]};	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :115:18, :117:22]
        s2_tlb_resp_pf_inst = _RANDOM[3'h6][4];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24]
        s2_tlb_resp_ae_inst = _RANDOM[3'h6][10];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24]
        s2_tlb_resp_cacheable = _RANDOM[3'h6][14];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24]
        s2_speculative = _RANDOM[3'h6][24];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :121:24, :123:31]
        s2_replay_REG = _RANDOM[3'h7][11];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :134:56]
        fq_io_enq_valid_REG = _RANDOM[3'h7][14];	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:82:7, :134:56, :184:29]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  ICache icache (	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:70:26]
    ...
    .io_req_bits_addr                                 ({_io_cpu_npc_T[32:0], 1'h0}),	// @[generators/rocket-chip/src/main/scala/rocket/Frontend.scala:174:27, :186:28]
