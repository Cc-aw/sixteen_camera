...
module TLUART(	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
  ...
  wire [6:0]       _rxq_io_count;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:133:19]
  ...
  wire [6:0]       _txq_io_count;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:130:19]
  ...
  reg  [6:0]       txwm;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:149:21]
  reg  [6:0]       rxwm;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:150:21]
  ...
  wire [3:0][63:0] _GEN = {{{48'h0, div}}, {{30'h0, ip_rxwm, ip_txwm, 30'h0, ie_rxwm, ie_txwm}}, {{9'h0, rxwm, 15'h0, rxen, 9'h0, txwm, 14'h0, nstop, txen}}, {{~_rxq_io_deq_valid, 23'h0, _rxq_io_deq_bits, ~_txq_io_enq_ready, 31'h0}}};	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:130:19, :133:19, :135:20, :141:21, :142:21, :149:21, :150:21, :151:22, :186:19, :189:28, :190:28, generators/rocket-chip-blocks/src/main/scala/util/RegMapFIFO.scala:24:9, :45:21, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24, generators/rocket-chip/src/main/scala/util/MuxLiteral.scala:49:{10,48}]
  always @(posedge clock) begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
    if (reset) begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
      ...
      txwm <= 7'h0;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:149:21]
      rxwm <= 7'h0;	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:150:21]
      ...
      if (out_woready_9 & auto_control_xing_in_a_bits_mask[2])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
        txwm <= auto_control_xing_in_a_bits_data[22:16];	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:149:21, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
      if (out_woready_9 & auto_control_xing_in_a_bits_mask[6])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
        rxwm <= auto_control_xing_in_a_bits_data[54:48];	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:150:21, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
      if (out_woready_9 & auto_control_xing_in_a_bits_mask[0])	// @[generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
    ...
    initial begin	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25]
        ...
        txwm = _RANDOM[1'h0][30:24];	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25, :135:20, :149:21]
        rxwm = {_RANDOM[1'h0][31], _RANDOM[1'h1][5:0]};	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25, :135:20, :150:21]
        nstop = _RANDOM[1'h1][6];	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25, :150:21, :151:22]
        ie_rxwm = _RANDOM[1'h1][8];	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25, :150:21, :186:19]
        ie_txwm = _RANDOM[1'h1][9];	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:127:25, :150:21, :186:19]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  Queue64_UInt8 txq (	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:130:19]
    .clock        (clock),
    .reset        (reset),
  ...
  Queue64_UInt8 rxq (	// @[generators/rocket-chip-blocks/src/main/scala/devices/uart/UART.scala:133:19]
    .clock        (clock),
    .reset        (reset),
    .io_enq_ready (/* unused */),
