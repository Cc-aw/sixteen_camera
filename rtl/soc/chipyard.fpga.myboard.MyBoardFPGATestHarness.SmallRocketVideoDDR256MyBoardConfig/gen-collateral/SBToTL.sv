...
module SBToTL(	// @[generators/rocket-chip/src/main/scala/devices/debug/SBA.scala:273:9]
  ...
  wire [103:0]    _GEN_6 = {io_addrIn[127:31], io_addrIn[30:24] ^ 7'h40};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [96:0]     _GEN_7 = {io_addrIn[127:32], ~(io_addrIn[31])};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  wire [96:0]     _GEN_8 = {io_addrIn[127:33], io_addrIn[32:31] ^ 2'h2};	// @[generators/rocket-chip/src/main/scala/diplomacy/Parameters.scala:139:{31,41,46}]
  ...
  Queue2_TLBundleD_a33d8s1k2z4u d_q (	// @[src/main/scala/chisel3/util/Decoupled.scala:362:21]
    .clock               (clock),
    .reset               (reset),
