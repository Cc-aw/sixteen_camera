...
module IntToFP(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7]
  ...
  wire [64:0]  i2fResults_2_1 = ({65{_i2fResults_i2f_2_io_out[63:61] != 3'h7}} | 65'h1EFEFFFFFFFFFFFFF) & _i2fResults_i2f_2_io_out;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:249:{25,56}, :414:10, :528:7, :556:23]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7]
    ...
    logic [31:0] _RANDOM[0:7];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7]
        for (logic [3:0] i = 4'h0; i < 4'h8; i += 4'h1) begin
          _RANDOM[i[2:0]] = `RANDOM;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7]
        ...
        io_out_pipe_pipe_b_data = {_RANDOM[3'h5][31:1], _RANDOM[3'h6], _RANDOM[3'h7][1:0]};	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7, src/main/scala/chisel3/util/Valid.scala:142:26]
        io_out_pipe_pipe_b_exc = _RANDOM[3'h7][6:2];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7, src/main/scala/chisel3/util/Valid.scala:142:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_out_bits_data = io_out_pipe_pipe_b_data;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7, src/main/scala/chisel3/util/Valid.scala:142:26]
  assign io_out_bits_exc = io_out_pipe_pipe_b_exc;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:528:7, src/main/scala/chisel3/util/Valid.scala:142:26]
endmodule
