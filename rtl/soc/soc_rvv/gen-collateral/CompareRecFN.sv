...
module CompareRecFN(	// @[generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:42:7]
  ...
  wire        bothInfs = (&(io_a[15:14])) & ~(io_a[13]) & (&(io_b[15:14])) & ~(io_b[13]);	// @[generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:58:33, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:51:21, :53:{28,53}, :56:41, :57:{33,36}]
  ...
  wire        common_ltMags = $signed({1'h0, io_a[15:10]}) < $signed({1'h0, io_b[15:10]}) | eqExps & _GEN < _GEN_0;	// @[generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:60:29, :62:{20,33,44,57}, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:51:21, :60:27, :61:44]
  ...
  wire        ordered_lt = ~bothZeros & (io_a[16] & ~(io_b[16]) | ~bothInfs & (io_a[16] & ~common_ltMags & ~common_eqMags | ~(io_b[16]) & common_ltMags));	// @[generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:58:33, :59:33, :62:33, :63:32, :66:{9,21}, :67:{25,28,41}, :68:{19,30}, :69:{35,38,54,57,74}, :70:41, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:57:33, :59:25]
  wire        ordered_eq = bothZeros | io_a[16] == io_b[16] & (bothInfs | common_eqMags);	// @[generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:58:33, :59:33, :63:32, :72:{19,34,49,62}, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:57:33, :59:25]
  ...
  assign io_gt = ordered & ~ordered_lt & ~ordered_eq;	// @[generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:42:7, :57:32, :66:21, :72:19, :80:{22,25,38,41}]
  assign io_exceptionFlags = {rawA_isNaN & ~(io_a[9]) | rawB_isNaN & ~(io_b[9]) | ~ordered, 4'h0};	// @[generators/hardfloat/hardfloat/src/main/scala/CompareRecFN.scala:42:7, :57:32, :75:{32,58}, :76:30, :81:34, generators/hardfloat/hardfloat/src/main/scala/common.scala:82:{46,49,56}, generators/hardfloat/hardfloat/src/main/scala/rawFloatFromRecFN.scala:56:33]
endmodule
