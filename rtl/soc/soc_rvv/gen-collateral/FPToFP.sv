...
module FPToFP(	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
    ...
    logic [31:0] _RANDOM[0:11];	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7]
  ...
  RecFNToRecFN_10 narrower (	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:619:30]
  ...
  RecFNToRecFN_9 narrower_1 (	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:619:30]
    .io_in             (in_pipe_b_in1),	// @[src/main/scala/chisel3/util/Valid.scala:142:26]
    .io_roundingMode   (in_pipe_b_rm),	// @[src/main/scala/chisel3/util/Valid.scala:142:26]
    .io_out            (_narrower_1_io_out),
    .io_exceptionFlags (_narrower_1_io_exceptionFlags)
  );	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:619:30]
  assign io_out_bits_data = io_out_pipe_pipe_b_data;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:142:26]
  assign io_out_bits_exc = io_out_pipe_pipe_b_exc;	// @[generators/rocket-chip/src/main/scala/tile/FPU.scala:573:7, src/main/scala/chisel3/util/Valid.scala:142:26]
endmodule
