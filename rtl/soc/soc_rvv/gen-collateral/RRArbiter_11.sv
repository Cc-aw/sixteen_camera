...
module RRArbiter_11(	// @[src/main/scala/chisel3/util/Arbiter.scala:118:7]
  ...
  wire [7:0][5:0] _GEN = {{io_in_0_bits_eg}, {io_in_0_bits_eg}, {io_in_0_bits_eg}, {io_in_4_bits_eg}, {io_in_3_bits_eg}, {io_in_2_bits_eg}, {io_in_1_bits_eg}, {io_in_0_bits_eg}};	// @[src/main/scala/chisel3/util/Arbiter.scala:55:16]
  ...
  wire            _ctrl_T_4 = _ctrl_T_3 | io_in_0_valid;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:68]
  wire            _ctrl_T_5 = _ctrl_T_4 | io_in_1_valid;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:68]
  wire            _ctrl_T_6 = _ctrl_T_5 | io_in_2_valid;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:68]
  assign io_chosen_choice = ctrl_validMask_1 ? 3'h1 : ctrl_validMask_2 ? 3'h2 : ctrl_validMask_3 ? 3'h3 : ctrl_validMask_4 ? 3'h4 : io_in_0_valid ? 3'h0 : io_in_1_valid ? 3'h1 : io_in_2_valid ? 3'h2 : io_in_3_valid ? 3'h3 : 3'h4;	// @[src/main/scala/chisel3/util/Arbiter.scala:82:49, :83:76, :90:41, :92:{26,35}, :94:{24,33}]
  wire [7:0]      _GEN_0 = {{io_in_0_valid}, {io_in_0_valid}, {io_in_0_valid}, {io_in_4_valid}, {io_in_3_valid}, {io_in_2_valid}, {io_in_1_valid}, {io_in_0_valid}};	// @[src/main/scala/chisel3/util/Arbiter.scala:55:16]
  always @(posedge clock) begin	// @[src/main/scala/chisel3/util/Arbiter.scala:118:7]
    if (io_out_ready & _GEN_0[io_chosen_choice])	// @[src/main/scala/chisel3/util/Arbiter.scala:55:16, :94:{24,33}, src/main/scala/chisel3/util/Decoupled.scala:51:35]
  ...
  assign io_in_0_ready = ~_ctrl_T_3 & io_out_ready;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:{68,78}, :74:21, :118:7]
  assign io_in_1_ready = (ctrl_validMask_grantMask_1 | ~_ctrl_T_4) & io_out_ready;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:{68,78}, :74:21, :82:49, :87:50, :118:7]
  assign io_in_2_ready = (~ctrl_validMask_1 & ctrl_validMask_grantMask_2 | ~_ctrl_T_5) & io_out_ready;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:{68,78}, :74:21, :82:49, :83:76, :87:{34,50}, :118:7]
  assign io_in_3_ready = (~_ctrl_T_1 & ctrl_validMask_grantMask_3 | ~_ctrl_T_6) & io_out_ready;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:{68,78}, :74:21, :82:49, :87:{34,50}, :118:7]
  assign io_in_4_ready = (~_ctrl_T_2 & ~(ctrl_validMask_grantMask_lastGrant[2]) | ~(_ctrl_T_6 | io_in_3_valid)) & io_out_ready;	// @[src/main/scala/chisel3/util/Arbiter.scala:45:{68,78}, :74:21, :81:33, :82:49, :87:{34,50}, :118:7]
