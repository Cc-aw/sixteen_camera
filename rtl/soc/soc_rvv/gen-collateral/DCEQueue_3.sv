...
module DCEQueue_3(	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
  ...
  input  [6:0]  io_enq_bits_eidx,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  input  [1:0]  io_enq_bits_rvs2_eew,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  input  [7:0]  io_enq_bits_vl,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  input         io_enq_bits_tail,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  input  [63:0] io_enq_bits_rvs2_data,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  ...
  output [6:0]  io_deq_bits_eidx,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  output [1:0]  io_deq_bits_rvs2_eew,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  output [7:0]  io_deq_bits_vl,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  output        io_deq_bits_tail,	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
  output [63:0] io_deq_bits_rvs2_data	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:20:14]
);

  reg         ram_0_slide;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [6:0]  ram_0_eidx;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [1:0]  ram_0_rvs2_eew;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [7:0]  ram_0_vl;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg         ram_0_tail;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [63:0] ram_0_rvs2_data;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg         ram_1_slide;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [6:0]  ram_1_eidx;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [1:0]  ram_1_rvs2_eew;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [7:0]  ram_1_vl;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg         ram_1_tail;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  reg  [63:0] ram_1_rvs2_data;	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:24:16]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
    ...
    logic [31:0] _RANDOM[0:5];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
    initial begin	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7]
        ...
        ram_0_slide = _RANDOM[3'h0][2];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_eidx = _RANDOM[3'h0][11:5];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_rvs2_eew = _RANDOM[3'h0][13:12];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_vl = _RANDOM[3'h0][24:17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_tail = _RANDOM[3'h0][25];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_0_rvs2_data = {_RANDOM[3'h0][31:26], _RANDOM[3'h1], _RANDOM[3'h2][25:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_slide = _RANDOM[3'h2][26];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_eidx = {_RANDOM[3'h2][31:29], _RANDOM[3'h3][3:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_rvs2_eew = _RANDOM[3'h3][5:4];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_vl = _RANDOM[3'h3][16:9];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_tail = _RANDOM[3'h3][17];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        ram_1_rvs2_data = {_RANDOM[3'h3][31:18], _RANDOM[3'h4], _RANDOM[3'h5][17:0]};	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16]
        wrap_1 = _RANDOM[3'h5][18];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, src/main/scala/chisel3/util/Counter.scala:61:40]
        wrap = _RANDOM[3'h5][19];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, src/main/scala/chisel3/util/Counter.scala:61:40]
        maybe_full = _RANDOM[3'h5][20];	// @[generators/saturn/src/main/scala/common/DCEQueue.scala:12:7, :24:16, :27:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
