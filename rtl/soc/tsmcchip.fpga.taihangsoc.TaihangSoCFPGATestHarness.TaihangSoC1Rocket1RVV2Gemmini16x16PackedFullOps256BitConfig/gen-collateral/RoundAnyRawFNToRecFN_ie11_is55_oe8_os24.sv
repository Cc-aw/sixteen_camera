...
module RoundAnyRawFNToRecFN_ie11_is55_oe8_os24(	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:48:5]
  ...
  wire        _GEN_0 = _roundMask_T_73[0] | io_in_sig[55];	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:120:57, :159:23, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:62:24]
  wire [25:0] _GEN_1 = {1'h1, ~(_roundMask_T_73[24:1]), ~_GEN_0};	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:159:23, :162:53, :163:28, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:62:24]
  wire [25:0] _GEN_2 = {_roundMask_T_73[24:1], _GEN_0, 1'h1};	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:159:{23,42}, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:62:24]
  wire [25:0] _roundPosBit_T = io_in_sig[55:30] & _GEN_1 & _GEN_2;	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:116:23, :159:42, :162:53, :163:46, :164:40]
  wire [25:0] _anyRoundExtra_T = {io_in_sig[54:30], |(io_in_sig[29:0])} & _GEN_2;	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:116:66, :117:{26,60}, :159:42, :165:42]
  wire [51:0] _GEN_3 = {_roundPosBit_T, _anyRoundExtra_T};	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:163:46, :164:{40,56}, :165:{42,62}, :166:36]
  ...
  wire [25:0] roundedSig = _overflow_roundMagUp_T & (|_roundPosBit_T) | roundMagUp & (|_GEN_3) ? {1'h0, io_in_sig[55:32] | _roundMask_T_73[24:1], io_in_sig[31] | _GEN_0} + 26'h1 & ~(roundingMode_near_even & (|_roundPosBit_T) & _anyRoundExtra_T == 26'h0 ? {_roundMask_T_73[24:1], _GEN_0, 1'h1} : 26'h0) : {1'h0, io_in_sig[55:31] & {~(_roundMask_T_73[24:1]), ~_GEN_0}} | (roundingMode_odd & (|_GEN_3) ? _GEN_1 & _GEN_2 : 26'h0);	// @[generators/hardfloat/hardfloat/src/main/scala/RoundAnyRawFNToRecFN.scala:90:53, :95:53, :98:42, :159:{23,42}, :162:53, :163:{28,46}, :164:{40,56}, :165:{42,62}, :166:36, :169:{38,67}, :170:31, :171:29, :173:16, :174:{32,49,57}, :175:{21,25,49,64}, :177:35, :180:{30,43,47}, :181:{24,42,67}, generators/hardfloat/hardfloat/src/main/scala/primitives.scala:62:24]
