...
module ram_2x1131(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input           R0_addr,
  input           R0_en,
  input           R0_clk,
  output [1130:0] R0_data,
  input           W0_addr,
  input           W0_en,
  input           W0_clk,
  input  [1130:0] W0_data
);

  reg [1130:0] Memory[0:1];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  ...
  `ifdef ENABLE_INITIAL_MEM_	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    reg [1151:0] _RANDOM_MEM;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [1:0] i = 2'h0; i < 2'h2; i += 2'h1) begin
          ...
          Memory[i[0]] = _RANDOM_MEM[1130:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
