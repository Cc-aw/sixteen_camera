...
module Repeater_TLBundleD_a33d256s8k5z4u(	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
  ...
  input  [4:0]   io_enq_bits_sink,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  output [4:0]   io_deq_bits_sink,	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:13:14]
  ...
  reg  [4:0]   saved_sink;	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:21:18]
  ...
  `ifdef ENABLE_INITIAL_REG_	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
    ...
    logic [31:0] _RANDOM[0:8];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
    initial begin	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
      ...
      `ifdef RANDOMIZE_REG_INIT	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7]
        ...
        saved_param = _RANDOM[4'h0][5:4];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_size = _RANDOM[4'h0][9:6];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_source = _RANDOM[4'h0][17:10];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_sink = _RANDOM[4'h0][22:18];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_denied = _RANDOM[4'h0][23];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_data = {_RANDOM[4'h0][31:24], _RANDOM[4'h1], _RANDOM[4'h2], _RANDOM[4'h3], _RANDOM[4'h4], _RANDOM[4'h5], _RANDOM[4'h6], _RANDOM[4'h7], _RANDOM[4'h8][23:0]};	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :20:21, :21:18]
        saved_corrupt = _RANDOM[4'h8][24];	// @[generators/rocket-chip/src/main/scala/util/Repeater.scala:10:7, :21:18]
      `endif // RANDOMIZE_REG_INIT
    end // initial
