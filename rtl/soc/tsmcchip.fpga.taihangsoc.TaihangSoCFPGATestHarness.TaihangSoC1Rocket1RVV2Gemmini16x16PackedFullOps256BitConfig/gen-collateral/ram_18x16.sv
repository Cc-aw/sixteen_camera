...
module ram_18x16(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [4:0]  R0_addr,
  input         R0_en,
  input         R0_clk,
  output [15:0] R0_data,
  ...
  reg [15:0] Memory[0:17];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [4:0] i = 5'h0; i < 5'h12; i += 5'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[15:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
