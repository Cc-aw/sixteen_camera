...
module ram_32x4(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [4:0] R0_addr,
  input        R0_en,
  input        R0_clk,
  output [3:0] R0_data,
  ...
  reg [3:0] Memory[0:31];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [5:0] i = 6'h0; i < 6'h20; i += 6'h1) begin
          ...
          Memory[i[4:0]] = _RANDOM_MEM[3:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
