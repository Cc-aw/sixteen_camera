...
module ram_5x89(	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
  input  [2:0]  R0_addr,
  input         R0_en,
  input         R0_clk,
  output [88:0] R0_data,
  ...
  reg [88:0] Memory[0:4];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
    ...
    initial begin	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
      ...
      `ifdef RANDOMIZE_MEM_INIT	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        for (logic [2:0] i = 3'h0; i < 3'h5; i += 3'h1) begin
          ...
          Memory[i] = _RANDOM_MEM[88:0];	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
        end
      `endif // RANDOMIZE_MEM_INIT
    end // initial
  `endif // ENABLE_INITIAL_MEM_
  assign R0_data = R0_en ? Memory[R0_addr] : 89'bx;	// @[src/main/scala/chisel3/util/Decoupled.scala:256:91]
endmodule
