...
|---|---|---|---|---|---|---|
| 既有自检查回归 | 通过 | 通过 | 未执行 | 未执行 | 未执行 | 未执行 |
| LUT/FF/BRAM/URAM/DSP | 122,305 / 223,485 / 424.5 / 0 / 18 | 121,740 / 223,525 / 424.5 / 0 / 18 | 未执行 | 未执行 | 未执行 | 未执行 |
| 300 MHz 自定义逻辑 | 已纳入层次/SLR 报告；独立精确计数待 P3 对比 | 仍是主要失败域；待 P3 迁移 | 未执行 | 未执行 | 未执行 | 未执行 |
